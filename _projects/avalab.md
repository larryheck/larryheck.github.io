...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/chris.jpg" title="example image" <a class="img-fluid rounded z-depth-1" href='https://scholar.google.com/citations?user=33ZWJmEAAAAJ&hl=en'></a>
        %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
